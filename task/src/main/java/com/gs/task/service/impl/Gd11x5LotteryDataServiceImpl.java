...
@Service
@Slf4j
public class Gd11x5LotteryDataServiceImpl extends LotteryDataService<OpenresultJsk3> {
    ...
    public void generatePaiqi(Date today) {
        ...
        List<OpenresultGd11x5> paiqiList = new ArrayList<>();
        for (Integer i = 1; i <= lottery.getDayCount(); i++) {
            OpenresultGd11x5 open = new OpenresultGd11x5();
        ...
        openresultGd11x5Service.saveBatch(paiqiList);
    ...
    public void openResult(LotterySourceProperties.SourceMerchants merchants, JSONObject jsonObject) {
        ...
        List<OpenresultGd11x5> list = new ArrayList<>();
        ...
        for (int i = 0; i < jsks.size(); i++) {
            ...
            OpenresultGd11x5 openresultJsk3 = new OpenresultGd11x5();
        ...
        openresultGd11x5Service.batchOpenResult(list);
    }
}
