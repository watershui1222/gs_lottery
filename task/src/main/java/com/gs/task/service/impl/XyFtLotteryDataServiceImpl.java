...
@Service
@Slf4j
public class XyFtLotteryDataServiceImpl extends LotteryDataService<OpenresultJsk3> {
    ...
    public void generatePaiqi(Date today) {
        ...
        List<OpenresultFt> paiqiList = new ArrayList<>();
        for (Integer i = 1; i <= lottery.getDayCount(); i++) {
            OpenresultFt open = new OpenresultFt();
        ...
        openresultFtService.saveBatch(paiqiList);
