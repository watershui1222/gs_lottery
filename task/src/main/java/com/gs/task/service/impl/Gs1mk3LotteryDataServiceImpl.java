...
@Service
@Slf4j
public class Gs1mk3LotteryDataServiceImpl extends LotteryDataService {
    ...
    public void generatePaiqi(Date today) {
        ...
        List<OpenresultGs1mk3> paiqiList = new ArrayList<>();
        for (Integer i = 1; i <= lottery.getDayCount(); i++) {
            OpenresultGs1mk3 open = new OpenresultGs1mk3();
        ...
        openresultGs1mk3Service.saveBatch(paiqiList);
