...
@Service
@Slf4j
public class Gs1mpl3LotteryDataServiceImpl extends LotteryDataService {
    ...
    public LotteryCodeEnum lotteryKindCode() {
        return LotteryCodeEnum.GS1MPL3;
    }
    ...
    public void generatePaiqi(Date today) {
        ...
        List<OpenresultGs1mpl3> paiqiList = new ArrayList<>();
        for (Integer i = 1; i <= lottery.getDayCount(); i++) {
            OpenresultGs1mpl3 open = new OpenresultGs1mpl3();
        ...
        openresultGs1mpl3Service.saveBatch(paiqiList);
