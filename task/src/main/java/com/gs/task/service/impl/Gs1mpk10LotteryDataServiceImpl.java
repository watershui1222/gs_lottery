...
@Service
@Slf4j
public class Gs1mpk10LotteryDataServiceImpl extends LotteryDataService {
    ...
    public LotteryCodeEnum lotteryKindCode() {
        return LotteryCodeEnum.GS1MPK10;
    }
    ...
    public void generatePaiqi(Date today) {
        ...
        List<OpenresultGs1mpk10> paiqiList = new ArrayList<>();
        for (Integer i = 1; i <= lottery.getDayCount(); i++) {
            OpenresultGs1mpk10 open = new OpenresultGs1mpk10();
        ...
        openresultGs1mpk10Service.saveBatch(paiqiList);
